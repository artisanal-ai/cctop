...
The project uses `uv` as its package manager and build tool, with Python 3.13+ as the minimum version requirement. Runtime dependencies can be found in the `pyproject.toml` file.
